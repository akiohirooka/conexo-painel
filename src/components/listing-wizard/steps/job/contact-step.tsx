...
export function JobContactStep() {
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between border-b pb-6">
                <div className="space-y-1">
                    <h3 className="text-lg font-medium">Contatos da Vaga</h3>
                    <p className="text-sm text-muted-foreground">Adicione os canais de contato para candidatos.</p>
                </div>
            ...
            {fields.length > 0 ? (
                ...
                <EmptyState
                    ...
                    description="Adicione os canais de contato para que os candidatos possam se candidatar."
                    icon={Share2}
                />
            )}
        </div>
